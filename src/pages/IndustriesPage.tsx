          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {industryData.map((industry, index) => (
                <div
                  key={index}
                  className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-start group border border-gray-100"
                >
                  <div className="mb-4 p-3 bg-gray-50 rounded-xl group-hover:bg-blue-50 transition-colors duration-300">
                    {industry.icon}
                  </div>
                  ...
                  <button
                    ...
                    className="w-full mt-auto inline-flex justify-center items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300 group-hover:shadow-lg"
                  >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-6 mb-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
