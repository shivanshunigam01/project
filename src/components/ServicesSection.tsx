  ...
  const services = [
    {
      ...
      description:
        "Boost your organic visibility and drive qualified traffic with our proven SEO strategies that deliver long-term results.",
      features: [
        "Keyword Research",
    ...
    },
    {
      ...
      description:
        "Build engaged communities and increase brand awareness across all major social media platforms.",
      features: [
        "Content Creation",
    ...
    },
    {
      ...
      description:
        "Maximize ROI with targeted PPC campaigns across Google Ads, Facebook, Instagram, and LinkedIn.",
      features: [
        "Campaign Setup",
        "Ad Optimization",
        "Budget Management",
    ...
    },
    {
      ...
      title: "Brand Design",
      description:
        "Create compelling visual identities that resonate with your audience and differentiate your brand.",
      features: [
        "Logo Design",
        "Brand Guidelines",
        "Marketing Materials",
    ...
    },
    {
      ...
      description:
        "Engage your audience with high-quality content that educates, entertains, and converts.",
      features: [
        "Content Strategy",
        "Blog Writing",
        "Video Production",
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                ...
                your business growth and establish a dominant online presence.
              </p>
            </div>
